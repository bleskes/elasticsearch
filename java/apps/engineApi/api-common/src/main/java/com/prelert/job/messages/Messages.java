...
public final class Messages
{
    ...
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_CATEGORICAL_TARGET_FIELD_NAME_NOT_SUPPORTED = "job.config.detectionrule.condition.categorical.targetfieldname.not.supported";
