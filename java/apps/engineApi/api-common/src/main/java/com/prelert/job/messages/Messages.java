...
public final class Messages
{
    ...
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_CATEGORICAL_CONDITION_NOT_SUPPORTED = "job.config.detectionrule.condition.categorical.condition.not.supported";
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_CATEGORICAL_FIELD_VALUE_NOT_SUPPORTED = "job.config.detectionrule.condition.categorical.fieldvalue.not.supported";
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_CATEGORICAL_REQUIRES_VALUE_LIST = "job.config.detectionrule.condition.categorical.requires.valuelist";
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_CATEGORICAL_TARGET_FIELD_NOT_SUPPORTED = "job.config.detectionrule.condition.categorical.targetfield.not.supported";
    ...
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_NUMERICAL_REQUIRES_CONDITION = "job.config.detectionrule.condition.numerical.requires.condition";
    ...
    public static final String JOB_CONFIG_DETECTION_RULE_CONDITION_NUMERICAL_VALUE_LIST_NOT_SUPPORTED = "job.config.detectionrule.condition.numerical.valuelist.not.supported";
    public static final String JOB_CONFIG_DETECTION_RULE_INVALID_TARGET_FIELD = "job.config.detectionrule.invalid.targetfield";
    public static final String JOB_CONFIG_DETECTION_RULE_MISSING_TARGET_FIELD = "job.config.detectionrule.missing.targetfield";
