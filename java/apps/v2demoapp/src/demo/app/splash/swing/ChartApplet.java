...
//		    addDataSource("serverload", "sol30m-8203.1.p2ps", "IDN_SELECTFEED", "#CCCC00");
			...
			for (TimeSeriesConfig config : m_TimeSeriesConfigs)
			{
		        ...
		        ArrayList<TimeSeriesDataPoint> usageData = (ArrayList<TimeSeriesDataPoint>)(in.readObject());
...
//	        in.close();
	...
	public void addTimeSeries(String label, ArrayList<TimeSeriesDataPoint> usageData)
	{
	...
	private TimeSeries buildTimeSeries(String name, List<TimeSeriesDataPoint> usageData)
	{
		TimeSeries timeSeries = new TimeSeries(name);
		
		for (TimeSeriesDataPoint dataItem: usageData)
		{
