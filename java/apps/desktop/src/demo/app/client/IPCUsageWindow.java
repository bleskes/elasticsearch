...
public class IPCUsageWindow extends ViewWindow
{
	...
	protected void createPagingToolBar()
	{
		DataProxy<DatePagingLoadConfig, DatePagingLoadResult> proxy = 
			new GetIPCUsageDataRpcProxy(m_Desktop.getIPCUsageQueryServiceInstance());
	...
	public void populateSources()
	{
		...
		m_Desktop.getIPCUsageQueryServiceInstance().getSources(new AsyncCallback<List<String>>(){
	 ...
	 */
	class GetIPCUsageDataRpcProxy<C extends DatePagingLoadConfig, D extends DatePagingLoadResult>
