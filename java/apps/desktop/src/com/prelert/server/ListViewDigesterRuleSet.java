...
public class ListViewDigesterRuleSet extends RuleSetBase
{
	...
	{
		addRuleInstances(digester, "com.prelert.data.ListView");
	}
	...
	public void addRuleInstances(Digester digester, String classToCreate)
	{
		...
		digester.addObjectCreate(m_Prefix + "/defaultOrderBy/sortInfo", "com.prelert.data.SortInformation");
		digester.addSetNext(m_Prefix + "/defaultOrderBy/sortInfo", "add", "com.prelert.data.SortInformation");	
