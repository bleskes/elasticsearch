...
public class EvidenceViewDigesterRuleSet extends ListViewDigesterRuleSet
{
	...
	{
		super.addRuleInstances(digester, "com.prelert.data.EvidenceView");
		
		digester.addCallMethod(getPrefix() + "/timeFrame", "setTimeFrame", 0);
		digester.addCallMethod(getPrefix() + "/filterableAttributes/attributeName", 
				"addFilterableAttribute", 0);
	}
