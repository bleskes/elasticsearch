 ...
 * the evidence displayed, and a ComboBox control for selecting the time frame
 * of the evidence data i.e. WEEK, DAY, HOUR, MINUTE or real-time (SECOND).
 * 
 * <dl>
...
public class EvidenceHistoryPagingToolBar extends EvidenceViewPagingToolBar
{
	...
	protected void onRender(Element target, int index)
	{
		...
		m_ToolBar.add(new AdapterToolItem(m_TimeFrameCombo));
	...
	/**
	 * Sets the Time Frame ComboBox to the selected value. Note that this simply
