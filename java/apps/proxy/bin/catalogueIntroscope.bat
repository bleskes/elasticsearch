...
"%PRELERT_JRE_HOME%\java" -Dprelert.logs="%PRELERT_HOME%\logs" -classpath "%PRELERT_HOME%\proxy\lib\log4j-1.2.16.jar;%PRELERT_HOME%\config\proxy;%PRELERT_HOME%\proxy\lib\*" com.prelert.proxy.plugin.introscope.CatalogueIntroscope -o "%PRELERT_HOME%\config\proxy" %*
