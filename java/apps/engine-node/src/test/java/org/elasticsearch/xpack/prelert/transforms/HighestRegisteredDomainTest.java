...
// TODO Reimplement
public class HighestRegisteredDomainTest extends ESTestCase {
...
//    {
//        List<TransformIndex> readIndexes = createIndexArray(new TransformIndex(0, 2));
...
//    {
//        List<TransformIndex> readIndexes = createIndexArray(new TransformIndex(0, 2));
//        List<TransformIndex> writeIndexes = createIndexArray(new TransformIndex(2, 0), new TransformIndex(2, 1));
//
//        HighestRegisteredDomain transform = new HighestRegisteredDomain(
//                                        readIndexes, writeIndexes, mock(Logger.class));
//
...
//    {
//        List<TransformIndex> readIndexes = createIndexArray(new TransformIndex(1, 2));
//        List<TransformIndex> writeIndexes = createIndexArray(new TransformIndex(2, 0), new TransformIndex(2, 1));
//
//        HighestRegisteredDomain transform = new HighestRegisteredDomain(
//                                        readIndexes, writeIndexes, mock(Logger.class));
