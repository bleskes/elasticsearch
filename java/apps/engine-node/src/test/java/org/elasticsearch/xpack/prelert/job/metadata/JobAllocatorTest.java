...
import static org.elasticsearch.mock.orig.Mockito.any;
import static org.elasticsearch.mock.orig.Mockito.times;

public class JobAllocatorTest extends ESTestCase {
    ...
    public void testClusterChanged_onlyAllocateIfMasterAndHaveUnAllocatedJobs() {
        ...
        PrelertMetadata.Builder pmBuilder = new PrelertMetadata.Builder();
        pmBuilder.putJob(new Job(new JobDetails("_id", new JobConfiguration())), false);
