...
public class LengthEncodedAutodetectProcessTest extends ESTestCase {

    private static final int NUMBER_ANALYSIS_FIELDS = 3;

    public void testProcessStartTime() throws InterruptedException {
        LengthEncodedAutodetectProcess process = new LengthEncodedAutodetectProcess(mock(OutputStream.class), NUMBER_ANALYSIS_FIELDS);
