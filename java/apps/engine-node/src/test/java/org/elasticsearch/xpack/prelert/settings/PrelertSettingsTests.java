...
public class PrelertSettingsTests extends ESTestCase {
    // @Rule
    ...
    // Path configFile =
    // PathUtils.get(getClass().getResource("/settings/empty_engine_api.yml").toURI());
    //
    // Map<Object, Object> settings =
    // PrelertSettings.loadSettingsFile(configFile);
    //
    // assertNotNull(settings);
    ...
    // Path configFile =
    // PathUtils.get(getClass().getResource("/settings/all_comment_engine_api.yml").toURI());
    //
    // Map<Object, Object> settings =
    // PrelertSettings.loadSettingsFile(configFile);
    //
    ...
    // Path configFile =
    // PathUtils.get(getClass().getResource("/settings/invalid_engine_api.yml").toURI());
    //
    // Map<Object, Object> settings =
    // PrelertSettings.loadSettingsFile(configFile);
    //
    ...
    // Path configFile =
    // PathUtils.get(getClass().getResource("/settings/valid_engine_api.yml").toURI());
    //
    // Map<Object, Object> settings =
    // PrelertSettings.loadSettingsFile(configFile);
    //
    ...
    //
    // public void
    // testGetSettingOrDefault_GivenSystemPropertyShouldMatchString() {
    ...
    // assertEquals("testvalue", PrelertSettings.getSettingOrDefault(env,
    // "testproperty", "default"));
    // }
    //
    // public void
    // testGetSettingOrDefault_GivenSystemPropertyShouldMatchInteger() {
    // Environment env = new Environment(
    // Settings.builder().put(Environment.PATH_HOME_SETTING.getKey(),
    // createTempDir().toString()).build());
    ...
    //
    // assertTrue(PrelertSettings.isSet(env, "testproperty"));
    // assertEquals(new Integer(42), PrelertSettings.getSettingOrDefault(env,
    // "testproperty", 4));
    // }
    //
    ...
    //
    // assertTrue(PrelertSettings.isSet(env, "testproperty"));
    // assertEquals(new Long(42), PrelertSettings.getSettingOrDefault(env,
    // "testproperty", 4L));
    // }
    //
    ...
    //
    // assertTrue(PrelertSettings.isSet(env, "testproperty"));
    // assertEquals(new Float(42.2), PrelertSettings.getSettingOrDefault(env,
    // "testproperty", 3.14f));
    // }
    //
    // public void
    // testGetSettingOrDefault_GivenSystemPropertyShouldMatchDouble() {
    // Environment env = new Environment(
    // Settings.builder().put(Environment.PATH_HOME_SETTING.getKey(),
    // createTempDir().toString()).build());
    // System.setProperty("testproperty", "42.2");
    //
    // assertTrue(PrelertSettings.isSet(env, "testproperty"));
    // assertEquals(new Double(42.2), PrelertSettings.getSettingOrDefault(env,
    // "testproperty", 3.14));
    // }
    //
    ...
    //
    // assertTrue(PrelertSettings.isSet(env, "testproperty"));
    // assertEquals(new Integer(3), PrelertSettings.getSettingOrDefault(env,
    // "testproperty", 3));
    // }
    //
    ...
    // assertEquals("default", PrelertSettings.getSettingOrDefault(env,
    // "testproperty", "default"));
    // }
    //
    ...
    // assertEquals(".", PrelertSettings.getSettingOrDefault(env,
    // "prelert.home", "."));
    // } else {
    // assertTrue(PrelertSettings.isSet(env, "prelert.home"));
    // assertEquals(prelertHomeEnv, PrelertSettings.getSettingOrDefault(env,
    // "prelert.home", "."));
    // }
    // }
}
