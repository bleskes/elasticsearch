 ...
 * @lucene.internal
 */
public final class XAppendingDeltaPackedLongBuffer extends XAbstractAppendingLongBuffer {

    static {
        // LUCENE MONITOR: this should be in Lucene 4.5 copied from Revision: 1508430.
    ...
    /**
     * Create {@link XAppendingDeltaPackedLongBuffer}
     *
     * @param initialPageCount        the initial number of pages
     * @param pageSize                the size of a single page
     * @param acceptableOverheadRatio an acceptable overhead ratio per value
     */
    public XAppendingDeltaPackedLongBuffer(int initialPageCount, int pageSize, float acceptableOverheadRatio) {
        super(initialPageCount, pageSize, acceptableOverheadRatio);
        minValues = new long[values.length];
    }

    /**
     * Create an {@link XAppendingDeltaPackedLongBuffer} with initialPageCount=16,
     * pageSize=1024 and acceptableOverheadRatio={@link PackedInts#DEFAULT}
     */
    public XAppendingDeltaPackedLongBuffer() {
     ...
     * pageSize=1024
     */
    public XAppendingDeltaPackedLongBuffer(float acceptableOverheadRatio) {
