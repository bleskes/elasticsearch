...
public class ShardReplicationOperationReplicaResponse extends TransportResponse {

    private SequenceNo maxConsecutiveSeqNo;

    ShardReplicationOperationReplicaResponse() {

    }

    public ShardReplicationOperationReplicaResponse(SequenceNo maxConsecutiveSeqNo) {
