...
public class PublishClusterStateAction extends AbstractComponent {
    ...
    public static final String ACTION_NAME = "internal:discovery/raft/publish";
    ...
    public static interface NewClusterStateListener {
        ...
        void onNewClusterState(long term, ClusterState clusterState, NewStateProcessed newStateProcessed);
    }
    ...
    private void publish(final long term, final ClusterState clusterState, final ClusterStatePublishResponseHandler publishResponseHandler) {

        DiscoveryNode localNode = raftDiscovery.localNode();
    ...
    private class PublishClusterStateRequestHandler extends BaseTransportRequestHandler<BytesTransportRequest> {
        ...
        public void messageReceived(BytesTransportRequest request, final TransportChannel channel) throws Exception {
            ...
            ClusterState clusterState = ClusterState.Builder.readFrom(in, raftDiscovery.localNode(), clusterName);
            ...
            listener.onNewClusterState(term, clusterState, new NewClusterStateListener.NewStateProcessed() {
                @Override
