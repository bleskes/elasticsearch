...
public class InternalEngineTests extends ElasticsearchLuceneTestCase {
    ...
    public void testEnableGcDeletes() throws Exception {
        ...
        engine.index(new Engine.Index(null, newUid("1"), doc, 1, VersionType.EXTERNAL, Engine.Operation.Origin.PRIMARY, System.nanoTime()));
    ...
    public void testSettings() {
        ...
        assertTrue(settings.containsSetting(EngineConfig.INDEX_CHECKSUM_ON_MERGE));
