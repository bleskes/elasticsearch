...
import org.elasticsearch.xpack.ml.support.AbstractDiffableSerializationTestCase;
...
public class PersistentTasksCustomMetaDataTests extends AbstractDiffableSerializationTestCase<Custom> {
    ...
    @Override
    protected PersistentTasksCustomMetaData parseInstance(XContentParser parser) throws IOException {
    ...
    public void testSerializationContext() throws Exception {
        ...
        PersistentTasksCustomMetaData newInstance = parseInstance(parser);
