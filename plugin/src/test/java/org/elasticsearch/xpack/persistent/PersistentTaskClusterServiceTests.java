...
public class PersistentTaskClusterServiceTests extends ESTestCase {
    ...
    private DiscoveryNode newNode(String nodeId) {
        return new DiscoveryNode(nodeId, new LocalTransportAddress("_fake_" + nodeId), emptyMap(),
    ...
    private ClusterState initialState()  {
        ...
        nodes.add(DiscoveryNode.createLocal(Settings.EMPTY, new LocalTransportAddress("_fake_this"), "this_node"));
