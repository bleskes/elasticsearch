...
public class SequenceNumbersService extends AbstractIndexShardComponent {
     ...
     */
    public void markAllocationIdAsInSync(final String allocationId, long localCheckpoint) throws InterruptedException {
    ...
    public void updateGlobalCheckpointOnPrimary() {
        globalCheckpointTracker.updateCheckpointOnPrimary();
    }
