...
public abstract class TranslogReader {
    ...
    private final long firstOperationOffset;
    ...
    abstract public long getMinSeqNo();

    abstract public long getMaxSeqNo();

    abstract public long getLocalCheckpoint();
    ...
    public Translog.Snapshot newSnapshot() {
        return new TranslogSnapshot(generation, channelReference, firstOperationOffset, sizeInBytes(), totalOperations(), getMinSeqNo(), getMaxSeqNo(), getLocalCheckpoint());
    }
    ...
    public String toString() {
        return "translog [gen [" + generation + "], minSeqNo [" + getMinSeqNo() + "], maxSeqNo [" + getMaxSeqNo() + "]][" + channelReference.getPath() + "]";
    }
