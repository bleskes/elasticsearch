 ...
 *
 */
final class ShardOptimizeRequest extends BaseBroadcastByNodeRequest<OptimizeRequest> {
    ShardOptimizeRequest() {
    }

    ShardOptimizeRequest(String nodeId, List<ShardRouting> shards, OptimizeRequest request) {
