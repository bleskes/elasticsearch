 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_vflib_ImportExport_h
#define INCLUDED_prelert_vflib_ImportExport_h
...
#ifdef BUILDING_libVf
// We're building the vflib library
#define VFLIB_EXPORT __declspec(dllexport)
#else
// We're building some code other than the vflib library
#define VFLIB_EXPORT __declspec(dllimport)
#endif
...
#endif // INCLUDED_prelert_vflib_ImportExport_h
