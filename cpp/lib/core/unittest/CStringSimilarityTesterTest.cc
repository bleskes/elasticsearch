...
void CStringSimilarityTesterTest::testLevensteinDistance2(void)
{
    ...
    sourceShutDown1.push_back("sol13m");
    sourceShutDown1.push_back("8608.1.p2ps");
    sourceShutDown1.push_back("Info");
    sourceShutDown1.push_back("Source");
    sourceShutDown1.push_back("AES_SERVICE2");
    ...
    sourceShutDown2.push_back("lnl13m");
    sourceShutDown2.push_back("8606.1.p2ps");
    sourceShutDown2.push_back("Info");
    sourceShutDown2.push_back("Source");
    sourceShutDown2.push_back("EUROBROKER");
    ...
    serviceStart.push_back("lnl13m");
    serviceStart.push_back("8606.1.p2ps");
    serviceStart.push_back("Info");
    serviceStart.push_back("Service");
    serviceStart.push_back("IDN_SELECTFEED");
    ...
    TStrVec noImageData;
    noImageData.push_back("sol13m");
    noImageData.push_back("8607.1.p2ps");
    ...
    noImageData.push_back("IDN_SELECTFEED");
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(3), sst.levenshteinDistance(sourceShutDown1, sourceShutDown2));
    CPPUNIT_ASSERT_EQUAL(size_t(3), sst.levenshteinDistance(sourceShutDown2, sourceShutDown1));

    CPPUNIT_ASSERT_EQUAL(size_t(8), sst.levenshteinDistance(sourceShutDown1, serviceStart));
    CPPUNIT_ASSERT_EQUAL(size_t(8), sst.levenshteinDistance(serviceStart, sourceShutDown1));
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(14), sst.levenshteinDistance(noImageData, serviceStart));
    CPPUNIT_ASSERT_EQUAL(size_t(14), sst.levenshteinDistance(serviceStart, noImageData));
...
void CStringSimilarityTesterTest::testWeightedEditDistance(void)
{
    ...
    sourceShutDown1.push_back(TStrSizePr("sol13m", 1));
    sourceShutDown1.push_back(TStrSizePr("8608.1.p2ps", 1));
    sourceShutDown1.push_back(TStrSizePr("Info", 3));
    sourceShutDown1.push_back(TStrSizePr("Source", 3));
    sourceShutDown1.push_back(TStrSizePr("AES_SERVICE2", 1));
    ...
    sourceShutDown2.push_back(TStrSizePr("lnl13m", 1));
    sourceShutDown2.push_back(TStrSizePr("8606.1.p2ps", 1));
    sourceShutDown2.push_back(TStrSizePr("Info", 3));
    sourceShutDown2.push_back(TStrSizePr("Source", 3));
    sourceShutDown2.push_back(TStrSizePr("EUROBROKER", 1));
    ...
    serviceStart.push_back(TStrSizePr("lnl13m", 1));
    serviceStart.push_back(TStrSizePr("8606.1.p2ps", 1));
    serviceStart.push_back(TStrSizePr("Info", 3));
    serviceStart.push_back(TStrSizePr("Service", 3));
    serviceStart.push_back(TStrSizePr("IDN_SELECTFEED", 1));
    ...
    noImageData.push_back(TStrSizePr("sol13m", 1));
    noImageData.push_back(TStrSizePr("8607.1.p2ps", 1));
    ...
    noImageData.push_back(TStrSizePr("IDN_SELECTFEED", 1));
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(3), sst.weightedEditDistance(sourceShutDown1, sourceShutDown2));
    CPPUNIT_ASSERT_EQUAL(size_t(3), sst.weightedEditDistance(sourceShutDown2, sourceShutDown1));

    CPPUNIT_ASSERT_EQUAL(size_t(18), sst.weightedEditDistance(sourceShutDown1, serviceStart));
    CPPUNIT_ASSERT_EQUAL(size_t(18), sst.weightedEditDistance(serviceStart, sourceShutDown1));
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(37), sst.weightedEditDistance(noImageData, serviceStart));
    CPPUNIT_ASSERT_EQUAL(size_t(37), sst.weightedEditDistance(serviceStart, noImageData));
