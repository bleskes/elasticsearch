...
int main(int argc, const char **argv)
{
    ...
    runner.addTest( CTextFileReaderTest::suite() );
    runner.addTest( CTextFileWatcherTest::suite() );
    runner.addTest( CTextFileWriterTest::suite() );
