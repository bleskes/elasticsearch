...
// We obfuscate the field names to avoid giving away too much information
// about our model.  There needs to be one constant here per sub-class of
// CPrior.  DO NOT change the existing tags if new sub-classes are added.
                                       ...
                                       core::CStateRestoreTraverser &traverser) const
{
    ...
    do
    {
        ...
        {
            // Due to the way we divide large state into multiple Splunk events
                                       ...
                                       core::CStateRestoreTraverser &traverser) const
{
    ...
    do
    {
        ...
        else if (name.find(CMultivariatePrior::LOG_NORMAL_TAG) != std::string::npos)
        {
            // TODO
            //ptr.reset(new CLogNormalMeanPrecConjugate(dataType, decayRate, traverser));
            //++numResults;
        }
