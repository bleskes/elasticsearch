...
class CCluster
{
    public:
        ...
        static CCluster merge(double height,
                              const CCluster &lhs,
                              const CCluster &rhs)
        {
            CCluster result;
            ...
            result.m_Points.insert(result.m_Points.end(),
                                   lhs.m_Points.begin(),
                                   lhs.m_Points.end());
            result.m_Points.insert(result.m_Points.end(),
                                   rhs.m_Points.begin(),
...
std::string print(maths::CAgglomerativeClusterer::EObjective o)
{
    switch (o)
    {
    case maths::CAgglomerativeClusterer::E_Single:   return "slink";
    case maths::CAgglomerativeClusterer::E_Complete: return "clink";
    case maths::CAgglomerativeClusterer::E_Average:  return "average";
    case maths::CAgglomerativeClusterer::E_Weighted: return "weighted";
    case maths::CAgglomerativeClusterer::E_Ward:     return "ward";
    }
    return "unexpected";
}
...
void CAgglomerativeClustererTest::testNode(void)
{
    ...
    std::sort(points.begin(), points.end());
    CPPUNIT_ASSERT_EQUAL(std::string("[2, 3, 4]"),
                         core::CContainerPrinter::print(points));

    {
        ...
        CPPUNIT_ASSERT_EQUAL(std::string("[(1, [0, 1]), (1.5, [2, 3]), (1.9, [4, 2, 3]), (4, [0, 1, 4, 2, 3])]"),
...
void CAgglomerativeClustererTest::testSimplePermutations(void)
{
    ...
    maths::CAgglomerativeClusterer::EObjective objectives[] =
        {
            maths::CAgglomerativeClusterer::E_Single,
