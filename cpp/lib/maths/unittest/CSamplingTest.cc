...
TDoubleVec minus(const TDoubleVec &v1,
                 const TDoubleVec &v2)
{
    TDoubleVec result;
...
TDoubleVecVec minus(const TDoubleVecVec &m1,
                    const TDoubleVecVec &m2)
{
...
TDoubleVecVec outer(const TDoubleVec &v1,
                    const TDoubleVec &v2)
{
    TDoubleVecVec result;
    for (std::size_t i = 0u; i < v1.size(); ++i)
...
void CSamplingTest::testMultinomialSample(void)
{
    ...
    TDoubleVec probabilities(boost::begin(probabilities_),
                             boost::end(probabilities_));
