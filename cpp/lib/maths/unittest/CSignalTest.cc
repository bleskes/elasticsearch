...
void CSignalTest::testFFTVersesOctave(void)
{
    LOG_DEBUG("+------------------------------------+");
    LOG_DEBUG("|  CSignalTest::testFFTVersesOctave  |");
    LOG_DEBUG("+------------------------------------+");

    // Test verses values calculated using octave fft.

    double x[][20] =
        {
            {
                2555.33,  1451.79,   465.60,  4394.83, -1553.24,
               -2772.07, -3977.73,  2249.31, -2006.04,  3540.84,
                4271.63,  4648.81,  -727.90,  2285.24,  3129.56,
               -3596.79, -1968.66,  3795.18,  1627.84,   228.40
            },
            {
                4473.77, -4815.63,  -818.38, -1953.72, -2323.39,
               -3007.25,  4444.24,   435.21,  3613.32,  3471.37,
               -1735.72,  2560.82, -2383.29, -2370.23, -4921.04,
                -541.25,  1516.69, -2028.42,  3981.02,  3156.88
            }
        };
...
void CSignalTest::testIFFTVersesOctave(void)
{
    LOG_DEBUG("+-------------------------------------+");
    LOG_DEBUG("|  CSignalTest::testIFFTVersesOctave  |");
    LOG_DEBUG("+-------------------------------------+");

    // Test verses values calculated using octave ifft.
...
void CSignalTest::testFFTRandomized(void)
{
    ...
    // Test on randomized input verses brute force.
...
CppUnit::Test *CSignalTest::suite(void)
{
    ...
    suiteOfTests->addTest( new CppUnit::TestCaller<CSignalTest>(
                                   "CSignalTest::testFFTVersesOctave",
                                   &CSignalTest::testFFTVersesOctave) );
    suiteOfTests->addTest( new CppUnit::TestCaller<CSignalTest>(
                                   "CSignalTest::testIFFTVersesOctave",
                                   &CSignalTest::testIFFTVersesOctave) );
    suiteOfTests->addTest( new CppUnit::TestCaller<CSignalTest>(
