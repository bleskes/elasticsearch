...
void CLinearAlgebraTest::testVectorNx1(void)
{
    ...
    }
    {
        ...
        for (std::size_t t = 0u; t < 20; ++t)
        {
            ...
            maths::CSymmetricMatrixNxN<double, 4> s(randomMatrix.selfadjointView<Eigen::Lower>());
            LOG_DEBUG("S   = " << s);
            maths::CVectorNx1<double, 4> y(randomVector);
            LOG_DEBUG("y   =\n" << y);
...
void CLinearAlgebraTest::testVector(void)
{
    ...
    }
    {
        ...
        for (std::size_t t = 0u; t < 20; ++t)
        {
            ...
            maths::CSymmetricMatrix<double> s(randomMatrix.selfadjointView<Eigen::Lower>());
            LOG_DEBUG("S   = " << s);
            maths::CVector<double> y(randomVector);
            LOG_DEBUG("y   =\n" << y);
