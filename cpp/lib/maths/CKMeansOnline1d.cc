...
typedef core::CSmallVector<TDouble4Vec, 4> TDouble4Vec1Vec;
                              ...
                              double count) const
{
    ...
    TNormalVecCItr rightCluster = std::lower_bound(m_Clusters.begin(),
                                                   m_Clusters.end(),
    ...
    {
        --rightCluster;
        result.push_back(std::make_pair(rightCluster - m_Clusters.begin(), count));
    }
    else if (rightCluster == m_Clusters.begin())
    {
        result.push_back(std::make_pair(size_t(0), count));
    }
    else
    {
        TNormalVecCItr leftCluster = rightCluster;
        --leftCluster;
        ...
        {
            result.push_back(std::make_pair(leftCluster - m_Clusters.begin(), count));
        }
        else
        {
            result.push_back(std::make_pair(leftCluster - m_Clusters.begin(), count * pLeft));
            result.push_back(std::make_pair(rightCluster - m_Clusters.begin(), count * pRight));
        }
    }
}
                          ...
                          double count)
{
    ...
    TDouble1Vec sample(1, point);
    TDouble4Vec1Vec weight(1, TDouble4Vec(1));
