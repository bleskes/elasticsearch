...
bool CIntegration::logGaussLegendreOrder3(const TLogFunc &function,
                                          double a,
                                          double b,
                                          double &result)
{
    return CIntegration::logGaussLegendre<OrderThree>(function, a, b, result);
}
...
const double *CIntegration::CGaussLegendreQuadrature::weights(EOrder order)
{
    switch (order)
    {
    case OrderOne:   return WEIGHTS1;
    case OrderTwo:   return WEIGHTS2;
    case OrderThree: return WEIGHTS3;
    case OrderFour:  return WEIGHTS4;
    case OrderFive:  return WEIGHTS5;
    case OrderSix:   return WEIGHTS6;
    case OrderSeven: return WEIGHTS7;
    case OrderEight: return WEIGHTS8;
    case OrderNine:  return WEIGHTS9;
    case OrderTen:   return WEIGHTS10;
    }
...
const double *CIntegration::CGaussLegendreQuadrature::abscissas(EOrder order)
{
    switch (order)
    {
    case OrderOne:   return ABSCISSAS1;
    case OrderTwo:   return ABSCISSAS2;
    case OrderThree: return ABSCISSAS3;
    case OrderFour:  return ABSCISSAS4;
    case OrderFive:  return ABSCISSAS5;
    case OrderSix:   return ABSCISSAS6;
    case OrderSeven: return ABSCISSAS7;
    case OrderEight: return ABSCISSAS8;
    case OrderNine:  return ABSCISSAS9;
    case OrderTen:   return ABSCISSAS10;
    }

    LOG_ABORT("Unexpected enumeration value " << order);
}

const double CIntegration::CGaussLegendreQuadrature::WEIGHTS1[] =
    {
        2.0
    };
const double CIntegration::CGaussLegendreQuadrature::WEIGHTS2[] =
    {
        1.0,
        1.0
    };
const double CIntegration::CGaussLegendreQuadrature::WEIGHTS3[] =
    {
        0.8888888888888888,
        0.5555555555555556,
        0.5555555555555556
    };
const double CIntegration::CGaussLegendreQuadrature::WEIGHTS4[] =
    {
        0.6521451548625461,
        0.6521451548625461,
        0.3478548451374538,
...
const double CIntegration::CGaussLegendreQuadrature::WEIGHTS5[] =
    {
        0.5688888888888889,
        0.4786286704993665,
        0.4786286704993665,
...
const double CIntegration::CGaussLegendreQuadrature::ABSCISSAS1[] =
    {
        0.0
    };
