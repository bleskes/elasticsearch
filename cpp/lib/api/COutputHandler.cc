...
bool COutputHandler::settings(const TStrStrUMap & /* settings */)
{
    // NOOP unless overridden
    return true;
}
...
bool COutputHandler::writeRow(bool isDryRun,
                              const TStrStrUMap &dataRowFields)
{
    ...
    return this->writeRow(isDryRun, EMPTY_FIELD_OVERRIDES, dataRowFields);
}
...
bool COutputHandler::periodicPersistState(core::CDataAdder & /* persister */)
{
    // NOOP unless overridden
    return true;
}
