...
CMultiFileDataAdder::TOStreamP CMultiFileDataAdder::addStreamed(const std::string &index,
                                                                ...
                                                                const std::string &id)
{
    const std::string &filename = this->makeFilename(index, type, id);
...
std::string CMultiFileDataAdder::makeCurrentDocId(const std::string &/*baseId*/,
                                                  size_t currentDocNum) const
{
    return core::CStringUtils::typeToString(currentDocNum);
}
