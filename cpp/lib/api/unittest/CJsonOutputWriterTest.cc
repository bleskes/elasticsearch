...
void CJsonOutputWriterTest::testWriteNonAnomalousBucket(void)
{
    ...
    CPPUNIT_ASSERT_EQUAL(0, bucket["record_count"].GetInt());
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.0, bucket["max_normalized_probability"].GetDouble(), 0.00001);
}
...
void CJsonOutputWriterTest::testBucketWriteHelper(bool isInterim)
{
    ...
    for (rapidjson::SizeType i = 1; i < arrayDoc.Size(); i = i + 2)
    {
        ...
        CPPUNIT_ASSERT_EQUAL(5, bucket["record_count"].GetInt());
        ...
        CPPUNIT_ASSERT_DOUBLES_EQUAL(0.8, bucket["max_normalized_probability"].GetDouble(), 0.00001);
...
void CJsonOutputWriterTest::testLimitedRecordsWriteHelper(bool isInterim)
{
    ...
    // bucket total anomaly score is the sum of all anomalies not just those printed.
    {
        ...
        const rapidjson::Value &bucket = bucketWrapper["bucket"];
        CPPUNIT_ASSERT(bucket.IsObject());
        CPPUNIT_ASSERT(bucket.HasMember("record_count"));
        CPPUNIT_ASSERT_EQUAL(8, bucket["record_count"].GetInt());  // total unlimited record count
        // It's hard to predict what these will be, so just assert their presence
        CPPUNIT_ASSERT(bucket.HasMember("anomaly_score"));
        CPPUNIT_ASSERT(bucket.HasMember("max_normalized_probability"));
        if (isInterim)
        {
            CPPUNIT_ASSERT(bucket.HasMember("is_interim"));
            CPPUNIT_ASSERT_EQUAL(isInterim, bucket["is_interim"].GetBool());
        ...
        for (rapidjson::SizeType i = 0; i < records.Size(); i++)
        {
            ...
            CPPUNIT_ASSERT(records[i].HasMember("sequence_num"));
        }
    ...
    }
    {
        ...
        CPPUNIT_ASSERT(bucket.IsObject());
        CPPUNIT_ASSERT(bucket.HasMember("record_count"));
        CPPUNIT_ASSERT_EQUAL(5, bucket["record_count"].GetInt());  // total unlimited record count
        // It's hard to predict what these will be, so just assert their presence
        CPPUNIT_ASSERT(bucket.HasMember("anomaly_score"));
        CPPUNIT_ASSERT(bucket.HasMember("max_normalized_probability"));
        if (isInterim)
    ...
    }
    {
        ...
        CPPUNIT_ASSERT(bucket.IsObject());
        CPPUNIT_ASSERT(bucket.HasMember("record_count"));
        CPPUNIT_ASSERT_EQUAL(2, bucket["record_count"].GetInt());  // total unlimited record count
        // It's hard to predict what these will be, so just assert their presence
        CPPUNIT_ASSERT(bucket.HasMember("anomaly_score"));
        CPPUNIT_ASSERT(bucket.HasMember("max_normalized_probability"));
        if (isInterim)
...
void CJsonOutputWriterTest::testWriteInfluencers(void)
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(10.0, influencer["initial_anomaly_score"].GetDouble(), 0.001);
    CPPUNIT_ASSERT(influencer.HasMember("anomaly_score"));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(10.0, influencer["anomaly_score"].GetDouble(), 0.001);
    ...
    CPPUNIT_ASSERT(influencer.HasMember("sequence_num"));
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(100.0, influencer2["initial_anomaly_score"].GetDouble(), 0.001);
    CPPUNIT_ASSERT(influencer2.HasMember("anomaly_score"));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(100.0, influencer2["anomaly_score"].GetDouble(), 0.001);
    ...
    CPPUNIT_ASSERT(influencer2.HasMember("sequence_num"));
...
void CJsonOutputWriterTest::testWriteInfluencersWithLimit(void)
{
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(100.0, influencer["initial_anomaly_score"].GetDouble(), 0.001);
    CPPUNIT_ASSERT(influencer.HasMember("anomaly_score"));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(100.0, influencer["anomaly_score"].GetDouble(), 0.001);
    CPPUNIT_ASSERT_EQUAL(std::string("user"), std::string(influencer["influencer_field_name"].GetString()));
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(12.0, influencer2["initial_anomaly_score"].GetDouble(), 0.001);
    CPPUNIT_ASSERT(influencer2.HasMember("anomaly_score"));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(12.0, influencer2["anomaly_score"].GetDouble(), 0.001);
...
void CJsonOutputWriterTest::testPartitionScores(void)
{
    ...
    for (rapidjson::SizeType i = 0; i < partitionScores.Size(); ++i)
    {
        ...
        CPPUNIT_ASSERT(pDoc.HasMember("anomaly_score"));
        CPPUNIT_ASSERT_DOUBLES_EQUAL(double(i), pDoc["anomaly_score"].GetDouble(), 0.01);
        CPPUNIT_ASSERT(pDoc.HasMember("initial_anomaly_score"));
        CPPUNIT_ASSERT_DOUBLES_EQUAL(double(i), pDoc["initial_anomaly_score"].GetDouble(), 0.01);
...
void CJsonOutputWriterTest::testReportMemoryUsage(void)
{
    ...
    CPPUNIT_ASSERT_EQUAL(1, sizeStats["model_bytes"].GetInt());
