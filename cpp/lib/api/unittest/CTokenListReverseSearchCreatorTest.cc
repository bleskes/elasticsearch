...
void CTokenListReverseSearchCreatorTest::testCostOfToken(void)
{
    ...
    CPPUNIT_ASSERT_EQUAL(std::size_t(0), reverseSearchCreator.costOfToken("someToken", 5));
}
...
void CTokenListReverseSearchCreatorTest::testCreateNoUniqueTokenSearch(void)
{
    ...
    CPPUNIT_ASSERT(reverseSearchCreator.createNoUniqueTokenSearch("access_combined",
                                                                  1,
                                                                  "404",
                                                                  4,
                                                                  reverseSearchPart1,
...
void CTokenListReverseSearchCreatorTest::testAddInOrderCommonToken(void)
{
    ...
    CPPUNIT_ASSERT_EQUAL(std::string("user logged logged"), reverseSearchPart1);
    CPPUNIT_ASSERT_EQUAL(std::string(".*?user.+?logged.+?logged"), reverseSearchPart2);
}
