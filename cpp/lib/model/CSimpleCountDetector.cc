...
CSimpleCountDetector::CSimpleCountDetector(int identifier,
      ...
      m_FieldValues(summaryMode == model_t::E_None ? 1 : 2)
{
    ...
    this->models().initSimpleCounting(CAnomalyDetector::m_Limits.resourceMonitor());
}
