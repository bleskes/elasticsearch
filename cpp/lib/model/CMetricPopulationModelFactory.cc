...
CModel *CMetricPopulationModelFactory::makeModel(const SModelInitializationData &initData) const
{
...
CModel *CMetricPopulationModelFactory::makeModel(const SModelInitializationData &initData,
...
CDataGatherer *CMetricPopulationModelFactory::makeDataGatherer(core::CStateRestoreTraverser &traverser) const
{
    return new CDataGatherer(model_t::E_PopulationMetric,
                             m_SummaryMode,
                             this->modelParams(),
