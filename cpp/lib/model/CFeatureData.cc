...
std::string SEventRateFeatureData::print(void) const
{
...
std::size_t SEventRateFeatureData::memoryUsage(void) const
{
...
std::string SMetricFeatureData::print(void) const
{
    std::ostringstream result;
...
std::size_t SMetricFeatureData::memoryUsage(void) const
{
