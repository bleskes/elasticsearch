...
const function_t::EFunction PEERS_COUNT       = function_t::E_PeersCount;
}

void CModelConfigTest::testNormal(void)
{
    {
        ...
        CPPUNIT_ASSERT_EQUAL(0.07, config.factory(1, PEERS_COUNT)->minimumModeFraction());
    ...
    }
    {
        ...
        CPPUNIT_ASSERT(dynamic_cast<const CEventRatePopulationModelFactory*>(config.factory(1, function_t::E_PopulationDistinctCount).get()));
...
void CModelConfigTest::testErrors(void)
{
    {
        ...
        CPPUNIT_ASSERT_EQUAL(config2.factory(1, PEERS_COUNT)->minimumModeFraction(),
                             config1.factory(1, PEERS_COUNT)->minimumModeFraction());
...
CppUnit::Test *CModelConfigTest::suite(void)
{
    CppUnit::TestSuite *suiteOfTests = new CppUnit::TestSuite("CModelConfigTest");

    suiteOfTests->addTest( new CppUnit::TestCaller<CModelConfigTest>(
                                   "CModelConfigTest::testNormal",
                                   &CModelConfigTest::testNormal) );
    suiteOfTests->addTest( new CppUnit::TestCaller<CModelConfigTest>(
                                   "CModelConfigTest::testErrors",
                                   &CModelConfigTest::testErrors) );
