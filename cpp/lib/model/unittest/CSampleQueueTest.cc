...
{
    CSample sample(10, TDoubleVec(1, 3.0), 0.8, 1.0);
...
void CSampleQueueTest::testAddGivenQueueIsEmptyShouldCreateNewSubSample(void)
{
    ...
    queue.add(1, TDoubleVec(1, 1.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(1), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[0].s_Statistic.sampleValue()[0]);
...
void CSampleQueueTest::testAddGivenTimeIsInOrderAndCloseToNonFullLatestSubSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);

    queue.add(3, TDoubleVec(1, 2.5), 2, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(1), queue.size());
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[0].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[0].s_End);
    CPPUNIT_ASSERT_EQUAL(2.0, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(2), queue[0].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsInOrderAndCloseToNonFullLatestSubSampleButDifferentBucket(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(9, TDoubleVec(1, 1.0), 1, sampleCount);

    queue.add(10, TDoubleVec(1, 2.5), 2, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(2), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(10), queue[0].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(10), queue[0].s_End);
    CPPUNIT_ASSERT_EQUAL(2.5, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(10), queue[0].s_Statistic.sampleTime());
    ...
    CPPUNIT_ASSERT_EQUAL(1.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsInOrderAndCloseToFullLatestSubSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[0].s_End);
    CPPUNIT_ASSERT_EQUAL(2.5, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(2.0, queue[0].s_Statistic.count());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(1.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[1].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsInOrderAndFarFromLatestSubSample(void)
{
    ...
    queue.add(5, TDoubleVec(1, 2.5), 2, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(2.5, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(5), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(2.0, queue[0].s_Statistic.count());
...
void CSampleQueueTest::testAddGivenTimeIsWithinFullLatestSubSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(0, TDoubleVec(1, 1.0), 2, sampleCount);
    queue.add(4, TDoubleVec(1, 1.0), 3, sampleCount);

    queue.add(3, TDoubleVec(1, 7.0), 1, sampleCount);
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndFarBeforeEarliestSubSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(8, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(15, TDoubleVec(1, 1.0), 3, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(7.0, queue[2].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[2].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloseBeforeFullEarliestSubSample(void)
{
    ...
    queue.add(5, TDoubleVec(1, 7.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(7.0, queue[2].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(5), queue[2].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[2].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloseBeforeNonFullEarliestSubSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(9, TDoubleVec(1, 1.0), 4, sampleCount);
    queue.add(15, TDoubleVec(1, 1.0), 3, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(2.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(8), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(5.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloseBeforeNonFullEarliestSubSampleButDifferentBucket(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(11, TDoubleVec(1, 1.0), 4, sampleCount);

    queue.add(9, TDoubleVec(1, 6.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(1.0, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(11), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(4.0, queue[0].s_Statistic.count());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(6.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndWithinSomeSubSample(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(6, TDoubleVec(1, 2.0), 1, sampleCount);
    queue.add(8, TDoubleVec(1, 4.0), 1, sampleCount);
    queue.add(12, TDoubleVec(1, 1.0), 1, sampleCount);

    queue.add(7, TDoubleVec(1, 6.0), 1, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(3), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(6), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(8), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(4.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(7), queue[1].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToSubSampleBeforeLatest(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(5, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(10, TDoubleVec(1, 4.0), 1, sampleCount);
    queue.add(15, TDoubleVec(1, 1.0), 1, sampleCount);

    queue.add(12, TDoubleVec(1, 6.0), 1, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(4), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(10), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(12), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(5.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(11), queue[1].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToSubSampleBeforeLatestButDifferentBucket(void)
{
    ...
    queue.add(10, TDoubleVec(1, 6.0), 1, sampleCount);
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToPreviousOfNonFullSubSamples(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(8, TDoubleVec(1, 2.0), 1, sampleCount);
    queue.add(15, TDoubleVec(1, 3.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[2].s_End);
    CPPUNIT_ASSERT_EQUAL(4.0, queue[2].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(2), queue[2].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToNextOfNonFullSubSamples(void)
{
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(8), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(4.5, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(7), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(2.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToPreviousOfFullSubSamples(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(8, TDoubleVec(1, 2.0), 5, sampleCount);
    queue.add(15, TDoubleVec(1, 3.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[2].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[2].s_End);
    CPPUNIT_ASSERT_EQUAL(2.0, queue[2].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(1), queue[2].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToNextOfFullSubSamples(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(8, TDoubleVec(1, 2.0), 5, sampleCount);
    queue.add(15, TDoubleVec(1, 3.0), 5, sampleCount);

    queue.add(5, TDoubleVec(1, 8.0), 1, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(3), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(5), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(8), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(3.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(8), queue[1].s_Statistic.sampleTime());
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToPreviousSubSampleButOnlyNextHasSpace(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(5, TDoubleVec(1, 2.0), 1, sampleCount);
    queue.add(10, TDoubleVec(1, 3.0), 1, sampleCount);

    queue.add(2, TDoubleVec(1, 7.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(4.5, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(4), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(2.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndCloserToNextSubSampleButOnlyPreviousHasSpace(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(5, TDoubleVec(1, 2.0), 5, sampleCount);
    queue.add(10, TDoubleVec(1, 3.0), 5, sampleCount);

    queue.add(3, TDoubleVec(1, 8.0), 1, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(3), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(0), queue[2].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[2].s_End);
    CPPUNIT_ASSERT_EQUAL(4.5, queue[2].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(2), queue[2].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(2.0, queue[2].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndFallsInBigEnoughGap(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(15, TDoubleVec(1, 2.0), 1, sampleCount);

    queue.add(6, TDoubleVec(1, 8.0), 1, sampleCount);

    CPPUNIT_ASSERT_EQUAL(std::size_t(3), queue.size());

    CPPUNIT_ASSERT_EQUAL(core_t::TTime(6), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(6), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(8.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(6), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testAddGivenTimeIsHistoricalAndFallsInTooSmallGap(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(4, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(9, TDoubleVec(1, 2.0), 1, sampleCount);

    queue.add(6, TDoubleVec(1, 7.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(6), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(3.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(3), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(3.0, queue[1].s_Statistic.count());
}
...
void CSampleQueueTest::testCanSample(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(24, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(26, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(45, TDoubleVec(1, 1.0), 5, sampleCount);
...
void CSampleQueueTest::testSampleGivenExactlyOneSampleOfExactCountToBeCreated(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(6, TDoubleVec(1, 3.0), 5, sampleCount);
    queue.add(30, TDoubleVec(1, 5.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_EQUAL(5.0, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(30), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[0].s_Statistic.count());
}
...
void CSampleQueueTest::testSampleGivenExactlyOneSampleOfOverCountToBeCreated(void)
{
    ...
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    TTestSampleQueue::TSampleVec samples;
    queue.add(0, TDoubleVec(1, 0.0), 3, sampleCount);
    queue.add(1, TDoubleVec(1, 1.0), 1, sampleCount);
    queue.add(6, TDoubleVec(1, 3.0), 7, sampleCount);
    queue.add(30, TDoubleVec(1, 5.0), 1, sampleCount);
    CPPUNIT_ASSERT(queue.canSample(0));
...
void CSampleQueueTest::testSampleGivenOneSampleToBeCreatedAndRemainder(void)
{
    ...
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(6, TDoubleVec(1, 3.0), 5, sampleCount);
    queue.add(7, TDoubleVec(1, 3.0), 1, sampleCount);
    queue.add(8, TDoubleVec(1, 5.0), 1, sampleCount);
    queue.add(40, TDoubleVec(1, 8.0), 1, sampleCount);
    CPPUNIT_ASSERT(queue.canSample(0));
    ...
    CPPUNIT_ASSERT_EQUAL(8.0, queue[0].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(40), queue[0].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[0].s_Statistic.count());
}
...
void CSampleQueueTest::testSampleGivenTwoSamplesToBeCreatedAndRemainder(void)
{
    ...
    TTestSampleQueue::TSampleVec samples;
    queue.add(0, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(2, TDoubleVec(1, 4.0), 5, sampleCount);
    queue.add(7, TDoubleVec(1, 2.0), 5, sampleCount);
    queue.add(8, TDoubleVec(1, 5.0), 5, sampleCount);
    queue.add(9, TDoubleVec(1, 0.0), 1, sampleCount);
    queue.add(30, TDoubleVec(1, 8.0), 1, sampleCount);
    CPPUNIT_ASSERT(queue.canSample(0));
    ...
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_Start);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_End);
    CPPUNIT_ASSERT_EQUAL(0.0, queue[1].s_Statistic.sampleValue()[0]);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(9), queue[1].s_Statistic.sampleTime());
    CPPUNIT_ASSERT_EQUAL(1.0, queue[1].s_Statistic.count());
...
void CSampleQueueTest::testSampleGivenNoSampleToBeCreated(void)
{
    ...
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    TTestSampleQueue::TSampleVec samples;
    queue.add(0, TDoubleVec(1, 1.0), 4, sampleCount);
    queue.add(30, TDoubleVec(1, 5.0), 1, sampleCount);
    CPPUNIT_ASSERT(queue.canSample(0));
...
void CSampleQueueTest::testSampleGivenUsingSubSamplesUpToCountExceedItMoreThanUsingOneLess(void)
{
    ...
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    TTestSampleQueue::TSampleVec samples;
    queue.add(0, TDoubleVec(1, 2.0), 5, sampleCount);
    queue.add(2, TDoubleVec(1, 2.0), 3, sampleCount);
    queue.add(10, TDoubleVec(1, 6.0), 6, sampleCount);
    queue.add(30, TDoubleVec(1, 8.0), 1, sampleCount);
    CPPUNIT_ASSERT(queue.canSample(0));
...
void CSampleQueueTest::testResetBucketGivenBucketBeforeEarliestSubSample(void)
{
    ...
    queue.add(10, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(15, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(20, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(24, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(29, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(30, TDoubleVec(1, 1.0), 5, sampleCount);
...
void CSampleQueueTest::testResetBucketGivenBucketAtEarliestSubSample(void)
{
    ...
    queue.add(10, TDoubleVec(1, 1.0), 3, sampleCount);
    queue.add(11, TDoubleVec(1, 1.0), 2, sampleCount);
    queue.add(15, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(20, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(24, TDoubleVec(1, 1.0), 5, sampleCount);
    queue.add(29, TDoubleVec(1, 1.0), 5, sampleCount);
...
void CSampleQueueTest::testSubSamplesNeverSpanOverDifferentBuckets(void)
{
    ...
    {
        TDoubleVec testData;
        rng.generateUniformSamples(latestTime - latency, latestTime, 1, testData);
        latestTime += 60 + 40 * std::sin(
                boost::math::constants::two_pi<double>() * (latestTime % 86400) / 86400);
        core_t::TTime measurementTime = static_cast<core_t::TTime>(testData[0]);
        queue.add(measurementTime, TDoubleVec(1, 1.0), 1u, sampleCount);
    }
...
void CSampleQueueTest::testPersistence(void)
{
    ...
    unsigned int sampleCount(10);
    TTestSampleQueue queue(1, sampleCountFactor, latencyBuckets, growthFactor, bucketLength);
    queue.add(0, TDoubleVec(1, 1.0), 3, sampleCount);
    queue.add(2, TDoubleVec(1, 3.5), 2, sampleCount);
    queue.add(30, TDoubleVec(1, 8.0), 1, sampleCount);
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(2.0, restoredQueue[1].s_Statistic.sampleValue()[0], 0.0001);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(1), restoredQueue[1].s_Statistic.sampleTime());
    ...
    CPPUNIT_ASSERT_DOUBLES_EQUAL(8.0, restoredQueue[0].s_Statistic.sampleValue()[0], 0.0001);
    CPPUNIT_ASSERT_EQUAL(core_t::TTime(30), restoredQueue[0].s_Statistic.sampleTime());
...
void CSampleQueueTest::testQualityOfSamplesGivenHighLatencyAndDataInReverseOrder(void)
{
    ...
    for (std::size_t measurementId = 0; measurementId < numberOfMeasurements; ++measurementId)
    {
        queue.add(time, TDoubleVec(1, 1.0), 1u, sampleCount);
        time -= 60;
    }
    queue.add(360000, TDoubleVec(1, 1.0), 1u, sampleCount);
    queue.sample(latestTime, sampleCount, model_t::E_IndividualMeanByPerson, samples);
