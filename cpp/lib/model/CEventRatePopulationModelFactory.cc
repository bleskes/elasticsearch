...
CModel *CEventRatePopulationModelFactory::makeModel(const SModelInitializationData &initData) const
{
...
CModel *CEventRatePopulationModelFactory::makeModel(const SModelInitializationData &initData,
                                                    core::CStateRestoreTraverser &traverser) const
{
    ...
    return new CEventRatePopulationModel(this->modelParams(),
                                         ...
                                         !initData.s_MultivariatePriors.empty() ?
                                             initData.s_MultivariatePriors : this->defaultMultivariatePriors(features),
                                         this->defaultDecompositions(features,
...
CDataGatherer *CEventRatePopulationModelFactory::makeDataGatherer(core::CStateRestoreTraverser &traverser) const
{
    return new CDataGatherer(model_t::E_PopulationEventRate,
                             m_SummaryMode,
                             this->modelParams(),
...
CEventRatePopulationModelFactory::TStrCRefVec
    CEventRatePopulationModelFactory::partitioningFields(void) const
{
    TStrCRefVec result;
    result.reserve(3);
