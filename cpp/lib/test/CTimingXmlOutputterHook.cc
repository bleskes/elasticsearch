                                            ...
                                            CppUnit::TestFailure * /*failure*/)
{
    ...
    testElement->elementFor(NAME_TAG)->setContent(
        m_TopPath + '.' + m_TestPath + '.' + testName);
}
                                                  ...
                                                  CppUnit::Test *test)
{
    ...
    testElement->addElement(
        new CppUnit::XmlElement(TEST_PATH_TAG,
                                m_TestPath + '/' + testName)
    );
    testElement->addElement(
        new CppUnit::XmlElement(TIME_TAG,
                                this->toSecondsStr(m_TestTimer.timeForTest(testName)))
    );
}
