...
//! \brief A univariate margin of a copula distribution.
//!
//! DESCRIPTION:\n
//! This implements a univariate component distribution for a multivariate
//! copula which is one of the margins.
//!
//! IMPLEMENTATION:\n
//! This is just a wrapper around a pointer to a CPrior object, which
//! implements all the necessary functionality.
class MATHS_EXPORT CCopulaMargin : public CMultivariateComponent
{
    public:
        typedef boost::shared_ptr<const CPrior> TPriorPtr;

    public:
        CCopulaMargin(const TPriorPtr &margin);
