...
#ifndef INCLUDED_prelert_maths_CMultivariateOneOfNPrior_h
#define INCLUDED_prelert_maths_CMultivariateOneOfNPrior_h
...
#endif // INCLUDED_prelert_maths_CMultivariateOneOfNPrior_h
