...
class MATHS_EXPORT CStatisticalTests
{
    ...
    public:
        //! Get the significance of an F-test for \p x when the test
        //! statistic has \p d1 and \p d2 degrees of freedom under
        //! the null hypothesis.
        static double fTest(double x, double d1, double d2);
