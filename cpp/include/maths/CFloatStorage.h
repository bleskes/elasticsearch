...
class MATHS_EXPORT CFloatStorage
{
    public:
        //! See core::CMemory.
        static bool dynamicSizeAlwaysZero(void) { return true; }

        //! Converts a float storage object to a string.
        class CToString
        {
            public:
        ...
        //! Initializes a float storage object from a string.
        class CFromString
        {
            public:
                bool operator()(const std::string &token,
                                CFloatStorage &value) const
                {
    ...
    public:
        ...
        {
            double value;
            if (core::CStringUtils::stringToType(string, value))
            {
                this->set(value);
                return true;
            }
        ...
        {
            return core::CStringUtils::typeToStringPrecise(static_cast<double>(m_Value),
