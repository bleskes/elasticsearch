...
#ifndef INCLUDED_prelert_maths_CMultivariatePrior_h
#define INCLUDED_prelert_maths_CMultivariatePrior_h
...
class MATHS_EXPORT CMultivariatePrior
{
    public:
        ...
        typedef std::pair<TDouble10Vec, TDouble10Vec> TDouble10VecDouble10VecPr;
        ...
        typedef boost::shared_ptr<CPrior> TUnivariatePriorPtr;
        typedef std::pair<TUnivariatePriorPtr, double> TUnivariatePriorPtrDoublePr;
        typedef boost::shared_ptr<CMultivariatePrior> TPriorPtr;
        typedef std::pair<TPriorPtr, double> TPriorPtrDoublePr;
    ...
    public:
        ...
        //@{
        static const std::string LOG_NORMAL_TAG;
    ...
    public:
        ...
        virtual ~CMultivariatePrior(void);
...
#endif // INCLUDED_prelert_maths_CMultivariatePrior_h
