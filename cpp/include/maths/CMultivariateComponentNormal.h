...
//! \brief A univariate component distribution of a multivariate normal.
//!
//! DESCRIPTION:\n
//! This implements a univariate component distribution for a multivariate
//! normal distribution which is a univariate normal. The normal parameters
//! are determined by whether the distribution is obtained by conditioning
//! of marginalizing over the other variables of the multivariate distribution.
//! See MultivariateNormalConjugate for more details.
//!
//! IMPLEMENTATION:\n
//! This is just a wrapper around CNormalMeanPrecConjugate which implements
//! all the necessary functionality.
class MATHS_EXPORT CMultivariateComponentNormal : public CMultivariateComponent
{
    public:
        CMultivariateComponentNormal(const CNormalMeanPrecConjugate &normal);
    ...
    private:
        //! The underlying representation of the margin.
        CNormalMeanPrecConjugate m_Normal;
};
