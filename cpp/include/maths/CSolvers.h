...
#ifndef INCLUDED_prelert_maths_CSolvers_h
#define INCLUDED_prelert_maths_CSolvers_h
...
class MATHS_EXPORT CSolvers
{
    private:
        ...
        static inline double bisect(const double a,
                                    const double b)
        {
            return (a + b) / 2.0;
        }
        ...
        static inline void shift(double &a,
                                 double &b,
                                 const double c)
        {
            a = b;
    ...
    public:
        ...
        //! \param[out] fx Set to the value of f at \p x.
        template<typename T, typename F>
        static bool globalMaximize(const T &p,
                                   const F &f,
                                   double &x,
                                   double &fx)
        {
...
#endif // INCLUDED_prelert_maths_CSolvers_h
