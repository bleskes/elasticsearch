...
class MATHS_EXPORT CTimeSeriesTestData
{
    public:
    ...
    public:
        ...
        //! A regular expression suitable for csv Splunk format.
        static const std::string CSV_SPLUNK_REGEX;
        //! A regular expression suitable for bivalued quantities
        //! for csv Splunk format.
        static const std::string CSV_SPLUNK_BIVALUED_REGEX;
        //! The date format for csv Splunk format.
        static const std::string CSV_SPLUNK_DATE_FORMAT;
