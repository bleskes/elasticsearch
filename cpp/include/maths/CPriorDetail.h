                         ...
                         const TDouble4Vec &weight) const
{
    ...
    CPriorUtils::CLogMarginalLikelihood<CPrior> logLikelihood(*this, weightStyles, weights);
    CCompositeFunctions::CExp<const CPriorUtils::CLogMarginalLikelihood<CPrior>&> likelihood(logLikelihood);
