...
#ifndef INCLUDED_prelert_maths_CMultimodalPrior_h
#define INCLUDED_prelert_maths_CMultimodalPrior_h
...
class MATHS_EXPORT CMultimodalPrior : public CPrior
{
    ...
    public:
        ...
        CMultimodalPrior(maths_t::EDataType dataType, TPriorPtrVec &priors);
    ...
    private:
        ...
        //! of offset.
        class MATHS_EXPORT CMultimodalOffsetCost : public COffsetCost
        {
            public:
                CMultimodalOffsetCost(CMultimodalPrior &prior);

            private:
                //! Capture a collection of re-samples from the prior modes.
            ...
            private:
                CMultimodalPrior *m_Prior;
                TDouble1VecVec m_Resamples;
                TDouble4Vec1VecVec m_ResamplesWeights;
        };

        //! \brief Apply a specified offset to the mode priors.
        class MATHS_EXPORT CMultimodalApplyOffset : public CApplyOffset
        {
            public:
                CMultimodalApplyOffset(CMultimodalPrior &prior);
        ...
        typedef TModeVec::const_iterator TModeVecCItr;
...
#endif // INCLUDED_prelert_maths_CMultimodalPrior_h
