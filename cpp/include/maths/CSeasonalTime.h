...
class MATHS_EXPORT CSeasonalTime
{
    public:
        ...
        core_t::TTime startOfRepeat(core_t::TTime time) const;
        ...
        virtual core_t::TTime repeatStart(void) const = 0;
    ...
    private:
        ...
        //! containing \p time.
        core_t::TTime startOfRepeat(core_t::TTime offset, core_t::TTime time) const;

        //! Get the scale to apply when computing the regression time.
        virtual core_t::TTime regressionTimeScale(void) const = 0;

        //! Get the length of a repeat in data.
        virtual core_t::TTime repeat(void) const = 0;
...
class MATHS_EXPORT CDiurnalTime : public CSeasonalTime
{
    public:
        ...
        virtual core_t::TTime repeatStart(void) const;
...
class MATHS_EXPORT CArbitraryPeriodTime : public CSeasonalTime
{
    public:
        CArbitraryPeriodTime(void);
        CArbitraryPeriodTime(core_t::TTime period);

        //! Get a copy of this time.
        CArbitraryPeriodTime *clone(void) const;
