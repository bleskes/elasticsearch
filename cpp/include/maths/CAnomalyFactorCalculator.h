 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_maths_CAnomalyFactorCalculator_h
#define INCLUDED_prelert_maths_CAnomalyFactorCalculator_h
...
#endif // INCLUDED_prelert_maths_CAnomalyFactorCalculator_h
