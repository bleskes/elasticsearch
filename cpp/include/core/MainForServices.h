 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_MainForServices_h
#define INCLUDED_prelert_core_MainForServices_h
...
// prelertMain() - this is the forward declaration of it.
extern int prelertMain(int argc, char *argv[]);
...
//!
//! Such programs MUST implement a prelertMain() function instead of
...
int main(int argc, char *argv[])
{
    ...
    if (process.startDispatcher(&prelertMain, argc, argv) == false)
    {
        return EXIT_FAILURE;
    }
...
#endif // INCLUDED_prelert_core_MainForServices_h
