 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_CDetachedProcessSpawner_h
#define INCLUDED_prelert_core_CDetachedProcessSpawner_h
...
//!    can be managed.
//!
//! On *nix the constuctor sets up signal handling to automatically reap
//! SIGCHLD signals from the spawned processes.  Obviously this means that
//! the process cannot then wait for SIGCHLD signals from processes spawned
//! by some other mechanism.  Once again, this points to this class only
//! being used in a process dedicated to spawning processes using this class.
//!
...
#endif // INCLUDED_prelert_core_CDetachedProcessSpawner_h
