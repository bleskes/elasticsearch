 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_CSleep_h
#define INCLUDED_prelert_core_CSleep_h
...
class CORE_EXPORT CSleep : private CNonInstantiatable
{
    ...
    public:
        ...
        //! system may round this up.  Solaris rounds any wait less than 20
        //! milliseconds to 20 milliseconds, and then rounds to multiples of 10
        //! above this.  Windows sleeps are multiples of 1/64 seconds, i.e.
        //! multiples of 15.625 milliseconds.  Basically, don't expect this to
        //! be ultra-accurate.
...
#endif // INCLUDED_prelert_core_CSleep_h
