 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_CStrPairFirstElementLess_h
#define INCLUDED_prelert_core_CStrPairFirstElementLess_h
...
#endif // INCLUDED_prelert_core_CStrPairFirstElementLess_h
