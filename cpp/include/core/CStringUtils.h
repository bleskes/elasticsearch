...
//! pre-processor.  The second (unused) argument avoids a compiler warning on
//! Solaris when "str" is an empty string.
#define STRINGIFY(str,unused) (#str)
#define STRINGIFY_MACRO(str) STRINGIFY(str,dummy)
