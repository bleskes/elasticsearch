 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_CJsonStateRestoreTraverser_h
#define INCLUDED_prelert_core_CJsonStateRestoreTraverser_h
...
#endif // INCLUDED_prelert_core_CJsonStateRestoreTraverser_h
