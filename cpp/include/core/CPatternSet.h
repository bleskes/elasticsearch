...
//!
//! DESCRIPTION:\n
//! Users can define lists to be used in conjunction with rules.
//! This class models those lists as a set and allows efficient lookups.
//! The supported list items are:
...
//! categories. They are then stored in a corresponsing prefix tree that allows
