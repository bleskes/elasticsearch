...
//! between systems.  On Solaris read/write locks are 4-5 times
//! slower than standard mutexes.  On Mac OS X, read/write locks
//! are twice as slow as Solaris, when a single CPU core would be
//! about 10 times faster!  Therefore, careful thought is required
