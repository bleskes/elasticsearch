 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_core_CStrPTime_h
#define INCLUDED_prelert_core_CStrPTime_h
...
//! functions on Linux and Solaris don't support the %z format, which is
//! required to parse localhost_access_log files.
//!
...
#endif // INCLUDED_prelert_core_CStrPTime_h
