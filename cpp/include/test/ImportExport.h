 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_test_ImportExport_h
#define INCLUDED_prelert_test_ImportExport_h
...
#else
// We're building some code other than the test library
...
#endif // INCLUDED_prelert_test_ImportExport_h
