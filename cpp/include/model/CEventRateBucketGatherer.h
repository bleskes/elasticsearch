...
class MODEL_EXPORT CUniqueStringFeatureData
{
    public:
        ...
        typedef boost::unordered_map<TStrPtr, TWordSet> TStrPtrWordSetUMap;
        typedef TStrPtrWordSetUMap::const_iterator TStrPtrWordSetUMapCItr;
        typedef std::vector<TStrPtrWordSetUMap> TStrPtrWordSetUMapVec;
    ...
    public:
        ...
        void insert(const std::string &value, const TStrPtrVec &influences);
    ...
    private:
        ...
        TStrPtrWordSetUMapVec m_InfluencerUniqueStrings;
};
...
class MODEL_EXPORT CEventRateBucketGatherer : public CBucketGatherer
{
    public:
        ...
        typedef TCategoryAnyMap::iterator TCategoryAnyMapItr;
        typedef TCategoryAnyMap::const_iterator TCategoryAnyMapCItr;
        typedef SEventRateFeatureData::TStrCRef TStrCRef;
        typedef SEventRateFeatureData::TDouble1Vec TDouble1Vec;
        typedef SEventRateFeatureData::TDouble1VecDoublePr TDouble1VecDoublePr;
        typedef SEventRateFeatureData::TStrCRefDouble1VecDoublePrPr TStrCRefDouble1VecDoublePrPr;
        ...
        typedef TSizeFeatureDataPrVec::iterator TSizeFeatureDataPrVecItr;
        typedef TSizeFeatureDataPrVec::const_iterator TSizeFeatureDataPrVecCItr;
        ...
        typedef TSizeSizePrFeatureDataPrVec::iterator TSizeSizePrFeatureDataPrVecItr;
        typedef TSizeSizePrFeatureDataPrVec::const_iterator TSizeSizePrFeatureDataPrCItr;
