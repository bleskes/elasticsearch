...
#ifndef INCLUDED_prelert_model_CCountingModel_h
#define INCLUDED_prelert_model_CCountingModel_h
...
class MODEL_EXPORT CCountingModel : public CModel
{
    public:
        //! \name Life-cycle.
        //@{
        ...
        //! \param[in] referenceModel The model for the reference data set
        //! against which to compare if non-null.
    ...
    private:
        //! The counts for the reference data set against which to compare
        //! if non-null.
        TModelCPtr m_ReferenceModel;
