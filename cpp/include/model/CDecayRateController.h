...
#ifndef INCLUDED_prelert_model_CDecayRateController_h
#define INCLUDED_prelert_model_CDecayRateController_h
...
#endif // INCLUDED_prelert_model_CDecayRateController_h
