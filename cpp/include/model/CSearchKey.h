...
#ifndef INCLUDED_prelert_model_CSearchKey_h
#define INCLUDED_prelert_model_CSearchKey_h
...
class MODEL_EXPORT CSearchKey
{
    ...
    public:
        ...
        const TStrPtrVec &influenceFieldNames(void) const;
    ...
    private:
        ...
        TStrPtr                   m_FieldName;
        TStrPtr                   m_ByFieldName;
        TStrPtr                   m_OverFieldName;
        TStrPtr                   m_PartitionFieldName;
        TStrPtrVec                m_InfluenceFieldNames;
    ...
    private:
        ...
        bool equal(const U &lhs, const V &rhs) const
        {
            return    boost::unwrap_ref(lhs.second) == boost::unwrap_ref(rhs.second)
                   && boost::unwrap_ref(lhs.first) == boost::unwrap_ref(lhs.first);
        }
};
...
#endif // INCLUDED_prelert_model_CSearchKey_h
