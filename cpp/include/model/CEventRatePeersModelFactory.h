...
#ifndef INCLUDED_prelert_model_CEventRatePeersModelFactory_h
#define INCLUDED_prelert_model_CEventRatePeersModelFactory_h
...
//! \brief A factory class implementation for CEventRatePeersModel.
//!
//! DESCRIPTION:\n
...
//! CEventRatePeersModel class.
class MODEL_EXPORT CEventRatePeersModelFactory : public CModelFactory
{
    public:
    ...
    public:
        ...
        explicit CEventRatePeersModelFactory(const SModelParams &params,
                                             model_t::ESummaryMode summaryMode = model_t::E_None,
                                             const std::string &summaryCountFieldName = "");

        //! Create a copy of the factory owned by the calling code.
        virtual CEventRatePeersModelFactory *clone(void) const;
        ...
        virtual CModel *makeModel(const SModelInitializationData &initData) const;
        ...
        //! \param[in,out] traverser A state document traverser.
        //! \warning It is owned by the calling code.
        virtual CDataGatherer *makeDataGatherer(core::CStateRestoreTraverser &traverser) const;
        //@}
        ...
        //! in a category of the sketch data.
    ...
    private:
        ...
        //! by an external aggregation process, such as the Splunk statistics
        //! command.
...
#endif // INCLUDED_prelert_model_CEventRatePeersModelFactory_h
