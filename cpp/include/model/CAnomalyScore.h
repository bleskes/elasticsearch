...
class MODEL_EXPORT CAnomalyScore
{
    ...
    public:
        ...
        {
            public:
                explicit CNormalizer(const CModelConfig &config);
            ...
            private:
                //! Manages upgrade of order statistic persistence style.
                bool restoreMaxScore(core::CStateRestoreTraverser &traverser);
                //@}
