...
class MODEL_EXPORT CBucketGatherer
{
    public:
        ...
        typedef std::pair<TSizeSizePr, TStrPtr> TSizeSizePrStrPtrPr;

        //! \brief Hashes a ((size_t, size_t), string*) pair.
        struct MODEL_EXPORT SSizeSizePrStrPtrPrHash
        {
            std::size_t operator()(const TSizeSizePrStrPtrPr &key) const
            {
        ...
        struct MODEL_EXPORT SSizeSizePrStrPtrPrEqual
        {
            bool operator()(const TSizeSizePrStrPtrPr &lhs,
                            const TSizeSizePrStrPtrPr &rhs) const
            {
                return lhs.first == rhs.first && *lhs.second == *rhs.second;
            }
        };

        typedef boost::unordered_map<TSizeSizePrStrPtrPr,
                                     uint64_t,
                                     SSizeSizePrStrPtrPrHash,
                                     SSizeSizePrStrPtrPrEqual> TSizeSizePrStrPtrPrUInt64UMap;
        typedef TSizeSizePrStrPtrPrUInt64UMap::const_iterator TSizeSizePrStrPtrPrUInt64UMapCItr;
        typedef TSizeSizePrStrPtrPrUInt64UMap::iterator TSizeSizePrStrPtrPrUInt64UMapItr;
        typedef std::vector<TSizeSizePrStrPtrPrUInt64UMap> TSizeSizePrStrPtrPrUInt64UMapVec;
        typedef CBucketQueue<TSizeSizePrStrPtrPrUInt64UMapVec> TSizeSizePrStrPtrPrUInt64UMapVecQueue;
        typedef TSizeSizePrStrPtrPrUInt64UMapVec::const_iterator TSizeSizePrStrPtrPrUInt64UMapVecCItr;
        typedef std::map<core_t::TTime, TSizeSizePrStrPtrPrUInt64UMapVec> TTimeSizeSizePrStrPtrPrUInt64UMapVecMap;
    ...
    public:
        ...
        const TSizeSizePrStrPtrPrUInt64UMapVec &influencerCounts(core_t::TTime time) const;
        //@}
    ...
    private:
        ...
        //! The (person, attribute) pair counts for longer bucketing intervals.
        ...
        //! pid-cid pairs for explicit nulls for longer bucketing intervals.
        ...
        TSizeSizePrStrPtrPrUInt64UMapVecQueue m_InfluencerCounts;

        //! The influencing field value counts for longer bucketing intervals.
        TTimeSizeSizePrStrPtrPrUInt64UMapVecMap m_MultiBucketInfluencerCounts;
};
