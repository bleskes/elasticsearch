...
#ifndef INCLUDED_prelert_model_t_ModelTypes_h
#define INCLUDED_prelert_model_t_ModelTypes_h
...
//! Function that knows how to persist a particular "extra data"
//! type that can be stored in boost::any.
typedef boost::function3<void,
                         const std::string &,
                         const boost::any &,
                         core::CStatePersistInserter &> TAnyPersistFunc;

//! Function that knows how to convert a particular "extra data"
//! type from a node document into some data type that can be assigned
//! to boost::any.
typedef boost::function1<boost::any, core::CStateRestoreTraverser &> TAnyRestoreFunc;

//! Function that knows how to register a memory callback for a particular
//! type of "extra data" that might be stored in a boost::any.
typedef boost::function1<void, core::CMemory::CAnyVisitor &> TAnyMemoryFunc;
...
//! Check if \p feature is conditional on attribute, i.e. if
//! there is a feature value for each (person, attribute).
MODEL_EXPORT
...
//! Check if the feature new prior is unchanging.
MODEL_EXPORT
bool newPriorFixed(EFeature feature);

//! Update a new prior with empty buckets.
MODEL_EXPORT
...
MODEL_EXPORT
double adjustProbability(model_t::EFeature feature,
...
//! guidelines).
#define CASE_INDIVIDUAL_COUNT case model_t::E_IndividualCountByBucketAndPerson:            \
...
#define CASE_INDIVIDUAL_METRIC case model_t::E_IndividualMeanByPerson:                    \
...
#define CASE_POPULATION_COUNT case model_t::E_PopulationAttributeTotalCountByPerson:               \
...
#define CASE_POPULATION_METRIC case model_t::E_PopulationMeanByPersonAndAttribute:          \
...
#define CASE_PEERS_COUNT case model_t::E_PeersAttributeTotalCountByPerson:               \
...
#define CASE_PEERS_METRIC case model_t::E_PeersMeanByPersonAndAttribute:         \
...
#endif // INCLUDED_prelert_model_t_ModelTypes_h
