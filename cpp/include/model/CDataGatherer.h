...
class MODEL_EXPORT CDataGatherer
{
    ...
    public:
        ...
        //! external aggregation process, such as the Splunk statistics
        //! command.
        ...
        //! \param[in] pid The unique identifier of the person of interest.
        //! \return The person name if they exist and a fallback otherwise.
        const TStrPtr &personNamePtr(std::size_t pid) const;
        ...
        const TStrPtr &attributeNamePtr(std::size_t cid) const;
