 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_model_ImportExport_h
#define INCLUDED_prelert_model_ImportExport_h
...
#else
// We're building some code other than the model library
...
#endif // INCLUDED_prelert_model_ImportExport_h
