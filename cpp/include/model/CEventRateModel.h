...
#ifndef INCLUDED_prelert_model_CEventRateModel_h
#define INCLUDED_prelert_model_CEventRateModel_h
...
class MODEL_EXPORT CEventRateModel : public CIndividualModel
{
    public:
        ...
        friend class CEventRateOnlineModelDetailsView;
    ...
    private:
        ...
        //! Get the detrended sample and weights for the univariate feature
        //! \p feature for computing the probability.
    ...
    private:
        ...
        TLessLikelyProbability m_Probabilities;
...
#endif // INCLUDED_prelert_model_CEventRateModel_h
