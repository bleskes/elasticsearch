...
#ifndef INCLUDED_prelert_model_CEventRateModelFactory_h
#define INCLUDED_prelert_model_CEventRateModelFactory_h
...
//! \brief A factory class implementation for CEventRateModel.
//!
//! DESCRIPTION:\n
...
class MODEL_EXPORT CEventRateModelFactory : public CModelFactory
{
    ...
    public:
        ...
        virtual CEventRateModelFactory *clone(void) const;

        //! \name Factory Methods
        //@{
        //! Make a new event rate model.
        //!
...
#endif // INCLUDED_prelert_model_CEventRateModelFactory_h
