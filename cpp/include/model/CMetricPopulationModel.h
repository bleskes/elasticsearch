...
#ifndef INCLUDED_prelert_model_CMetricPopulationModel_h
#define INCLUDED_prelert_model_CMetricPopulationModel_h
...
class MODEL_EXPORT CMetricPopulationModel : public CPopulationModel
{
    ...
    public:
        ...
        CMetricPopulationModel(bool isForPersistence,
    ...
    private:
        ...
        //! The priors for the attribute metric univariate feature.
        TFeaturePriorPtrVecMap m_AttributePriors;

        //! The priors for the attribute metric multivariate feature.
...
#endif // INCLUDED_prelert_model_CMetricPopulationModel_h
