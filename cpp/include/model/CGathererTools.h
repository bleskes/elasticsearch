...
#ifndef INCLUDED_prelert_model_CGathererTools_h
#define INCLUDED_prelert_model_CGathererTools_h
    ...
    public:
        ...
        class MODEL_EXPORT CSumGatherer
        {
            public:
                ...
                typedef CBucketQueue<TStrPtrDoubleUMap> TStrPtrDoubleUMapQueue;
                typedef TStrPtrDoubleUMapQueue::const_reverse_iterator TStrPtrDoubleUMapQueueCRItr;
                typedef std::vector<TStrPtrDoubleUMapQueue> TStrPtrDoubleUMapQueueVec;
            ...
            public:
                         ...
                         const TStrPtrVec &influences)
                {
                    ...
                    for (std::size_t i = 0u; i < influences.size(); ++i)
                    {
                        ...
                        TStrPtrDoubleUMap &sums = m_InfluencerBucketSums[i].get(time);
            ...
            private:
                ...
                //! the latency window.
                TStrPtrDoubleUMapQueueVec m_InfluencerBucketSums;
        };
};
...
#endif // INCLUDED_prelert_model_CGathererTools_h
