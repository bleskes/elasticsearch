...
#ifndef INCLUDED_prelert_model_CHierarchicalResultsAggregator_h
#define INCLUDED_prelert_model_CHierarchicalResultsAggregator_h
...
{
    public:
        typedef CHierarchicalResultsLevelSet<CDetectorEqualizer> TBase;
        typedef TBase::Type TDetectorEqualizer;
        typedef TBase::TTypePtrVec TDetectorEqualizerPtrVec;
    ...
    public:
        CHierarchicalResultsAggregator(const CModelConfig &modelConfig);
        ...
        void refresh(const CModelConfig &modelConfig);
    ...
    private:
        ...
        //! across detectors.
        double correctProbability(const TNode &node,
                                  bool pivot,
                                  int detector,
                                  double probability);
...
#endif // INCLUDED_prelert_model_CHierarchicalResultsAggregator_h
