...
#ifndef INCLUDED_prelert_model_CMetricModelFactory_h
#define INCLUDED_prelert_model_CMetricModelFactory_h
...
class MODEL_EXPORT CMetricModelFactory : public CModelFactory
{
    ...
    public:
        ...
        //! Make a new metric model from part of an XML document.
        //!
        ...
        //! Make a new metric data gatherer from part of an XML document.
        //!
        //! \param[in,out] traverser A state document traverser.
        //! \warning It is owned by the calling code.
...
#endif // INCLUDED_prelert_model_CMetricModelFactory_h
