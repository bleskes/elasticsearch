...
class API_EXPORT CJsonOutputWriter : public COutputHandler
{
    public:
        ...
        typedef std::pair<TDocumentPtr, int>           TDocumentPtrIntPr;
        typedef std::vector<TDocumentPtrIntPr>         TDocumentPtrIntPrVec;
        typedef TDocumentPtrIntPrVec::iterator         TDocumentPtrIntPrVecItr;


        typedef std::map<std::string, TDocumentPtrVec> TStrDocumentPtrVecMap;
        typedef TStrDocumentPtrVecMap::iterator        TStrDocumentPtrVecMapItr;
        typedef TStrDocumentPtrVecMap::const_iterator  TStrDocumentPtrVecMapCItr;
        ...
        typedef TStringDoublePrVec::const_iterator     TStringDoublePrVecCItr;
        ...
        struct SBucketData
        {
            ...
            //! detector index
            TDocumentPtrIntPrVec  s_DocumentsToWrite;

            //! Bucket Influencer documents
            TDocumentPtrVec       s_BucketInfluencerDocuments;

            //! Influencer documents
            TDocumentPtrVec       s_InfluencerDocuments;
            ...
            //! Partition scores
            TDocumentPtrVec       s_PartitionScoreDocuments;
        };
        ...
        static const std::string RECORD_COUNT;
        ...
        static const std::string RESTORE_PRIORITY;
        ...
        static const std::string SEQUENCE_NUM;
    ...
    private:
        ...
        struct SModelSnapshotReport
        {
            ...
            core_t::TTime                     s_LatestResultsTime;
        };
    ...
    public:
        ...
        //! Hijack the JSON writer to write some arbitrary JSON documents.  The
        //! caller must only use this writer from one thread, and must not allow
        //! another method on this object to be called whilst it holds the
        //! returned reference.  Currently used by the model debug
        //! functionality.
        CJsonOutputWriter::TGenericLineWriter &hijackJsonWriter(void);
    ...
    private:
        ...
        void addInfluences(const CHierarchicalResultsWriter::TStrPtrStrPtrPrDoublePrVec &influenceResults,
                           rapidjson::Document &doc);
    ...
    private:
        ...
        //! Have we opened a JSON array that needs to be closed on destruction?
        bool                              m_CloseJsonStructures;
