...
class API_EXPORT CDetectionRulesJsonParser
{
    ...
    public:
        //! Default constructor
        CDetectionRulesJsonParser(TStrPatternSetUMap &listsByIdMap);
    ...
    private:
        ...
        bool parseValueList(const rapidjson::Value &conditionObject,
        ...
        static bool parseRuleAction(const rapidjson::Value &ruleObject, model::CDetectionRule &rule);
    ...
    private:
        ...
        TStrPatternSetUMap &m_ListsByIdMap;
};
}
}
