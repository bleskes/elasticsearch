 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_api_CInputParser_h
#define INCLUDED_prelert_api_CInputParser_h
...
class API_EXPORT CInputParser : private core::CNonCopyable
{
    public:
        ...
        typedef std::list<TStrStrUMap>                         TStrStrUMapList;
        typedef TStrStrUMapList::iterator                      TStrStrUMapListItr;
        typedef TStrStrUMapList::const_iterator                TStrStrUMapListCItr;

        //! Callback function prototype for passing on settings.
        typedef boost::function1<bool,
                                 const TStrStrUMap &>          TSettingsFunc;

        //! Callback function prototype that gets called for each record
        //! read from the input stream.  Return false to exit reader loop.
        //! Arguments are:
        //! 1) Is this a dry run, i.e. should we not output any results?
        //! 2) Header row fields
        //! 3) Data row fields
        typedef boost::function3<bool,
                                 bool,
                                 const TStrVec &,
                                 const TStrStrUMap &>          TReaderFunc;
    ...
    public:
        ...
        virtual bool readStream(bool doDryRun,
                                ...
                                const TReaderFunc &readerFunc) = 0;
...
#endif // INCLUDED_prelert_api_CInputParser_h
