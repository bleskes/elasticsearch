 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_api_CTokenListReverseSearchCreatorIntf_h
#define INCLUDED_prelert_api_CTokenListReverseSearchCreatorIntf_h
...
//! At the time of writing, only the Splunk reverse search creator
//! implements this interface.  However, it is possible that in the
//! future categorisation will be added to the REST API, and then
//! another derived class will be required.
//!
...
class API_EXPORT CTokenListReverseSearchCreatorIntf
{
    public:
        ...
        virtual size_t availableCost(const std::string &sourceType) const = 0;
        ...
        //! false.)
        virtual bool createNoUniqueTokenSearch(const std::string &sourceType,
                                               int type,
        ...
        virtual void initStandardSearch(const std::string &sourceType,
                                        int type,
                                        const std::string &example,
                                        size_t maxMatchingStringLen,
                                        std::string &part1,
        ...
        virtual void closeStandardSearch(const std::string &sourceType,
                                         std::string &part1,
...
#endif // INCLUDED_prelert_api_CTokenListReverseSearchCreatorIntf_h
