 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_api_ImportExport_h
#define INCLUDED_prelert_api_ImportExport_h
...
#else
// We're building some code other than the api library
...
#endif // INCLUDED_prelert_api_ImportExport_h
