 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_api_CResultNormalizer_h
#define INCLUDED_prelert_api_CResultNormalizer_h
...
class API_EXPORT CResultNormalizer
{
    ...
    public:
        CResultNormalizer(const model::CModelConfig &modelConfig,
    ...
    private:
        bool parseDataFields(const TStrVec &fieldNames, const TStrStrUMap &dataRowFields,
        ...
        template<typename T>
        bool parseDataField(const TStrVec &fieldNames,
                            const TStrStrUMap &dataRowFields,
                            ...
                            T &result) const
        {
                ...
                core::CStringUtils::stringToType(iter->second, result) == false)
            {
                LOG_ERROR("Cannot interpret " << fieldName << " field in record:\n" <<
                        CDataProcessor::debugPrintRecord(fieldNames, dataRowFields));
                return false;
            }
            return true;
        }
...
#endif // INCLUDED_prelert_api_CResultNormalizer_h
