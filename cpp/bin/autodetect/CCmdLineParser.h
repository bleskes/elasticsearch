 ...
 * strictly prohibited.
 */
#ifndef INCLUDED_prelert_autodetect_CCmdLineParser_h
#define INCLUDED_prelert_autodetect_CCmdLineParser_h
...
#endif // INCLUDED_prelert_autodetect_CCmdLineParser_h
