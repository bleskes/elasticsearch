...
CPPFLAGS=-isystem $(SYSROOT)/usr/include/c++/v1 -isystem $(CPP_SRC_HOME)/3rd_party/include -isystem $(SYSROOT)/usr/local/include -D$(OS) -DBOOST_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS -DEIGEN_MPL2_ONLY $(OPTCPPFLAGS)
...
CAT=cat
LN=ln
AR=/usr/local/bin/$(CROSS_TARGET_PLATFORM)-ar -rus
ID=/usr/bin/id -u
