...
* Watches now have an <<watch-active-state, active state>>. In addition, a new
  API was added to {ref}/watcher-api-activate-watch.html[activate] or
...
* Cleaned up the {ref}/watcher-api-stats.html[Stats API] response.
...
.New Features
* Added {ref}/watcher-api-execute-watch.html#watcher-api-execute-inline-watch[inline watch] support to the Execute API
...
{ref}/watcher-api-stats.html[Stats API].
...
* The {ref}/watcher-api-execute-watch.html[Execute API] now supports a default trigger
