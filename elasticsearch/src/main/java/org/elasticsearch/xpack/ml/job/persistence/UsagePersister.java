...
import static org.elasticsearch.xpack.ml.job.persistence.JobProvider.ML_USAGE_INDEX;
...
public class UsagePersister extends AbstractComponent {
    ...
    public void persistUsage(String jobId, long bytesRead, long fieldsRead, long recordsRead) {
        ...
        // update global count
        updateDocument(jobId, ML_USAGE_INDEX, docId, bytesRead, fieldsRead, recordsRead);
